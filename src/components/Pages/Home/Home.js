...
const Home = () => {
    ...
    return (
        <div>
            <div className="banner grid-sec grid lg:grid-cols-2 grid-cols-1 gap-10 items-start p-8 lg:px-16 lg:py-20">
                <div className='flex flex-col gap-10 pt-10'>
                    <h1 className="text-3xl lg:text-6xl">Take your <span>cloud DevOps</span> career to the next <span>level</span></h1>
            ...
            <div className="curriculam grid-sec grid lg:grid-cols-2 grid-cols-1 items-center p-5 lg:px-16 lg:py-20">
                ...
                <div className='flex flex-col items-end text-center lg:text-right gap-10 pt-10'>
                    <h1 className="text-3xl lg:text-5xl">Essential knowledge for <span>beginning a career in DevOps</span></h1>
                    <p>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
            ...
            <div className="project-based grid-sec grid lg:grid-cols-2 grid-cols-1 lg:gap-20 gap-10 items-start px-5 py-10 lg:px-16 lg:py-20">
                <div className='flex flex-col gap-10 lg:pt-10'>
                    <h1 className="text-2xl lg:text-5xl">Project-Based Learning: Obtaining Real-World Experience</h1>
                    ...
                    <button className='btn text-[#71B131] flex items-center gap-4'><p className="border-b border-lime-500 hover:border-none text-[#71B131]">Download Curriculam</p> <i class="fa-solid fa-arrow-right"></i></button>
                </div>
                <div className='grid-img lg:p-0 p-8 flex items-start justify-start'>
            ...
            <div className="flex flex-col gap-5 text-center px-5 lg:px-16 py-5 bg-white">
                ...
                <p className='alumni-des'>Gain experience by working on real-world projects: Contribute to open source projects, work on personal projects, or participate in hackathons to gain hands-on experience with cloud DevOps tools and techniques.</p>
            </div>

            <div className="py-5 text-center">
                <img src={map} alt="" />
                <div className="p-5">
                    <h1 className="text-2xl lg:text-6xl mb-5"><span>Perks</span> of Signing Up </h1>
                    <p className='w-full lg:w-3/5 flex mx-auto'>Build your professional network. Connect with other devops professionals through professional associations, networking events, or online communities to learn from their experiences and stay up-to-date on the latest developments in the field.</p>
                </div>
            ...
            <div className="lg:p-16 p-5 text-center video-sec bg-white">
                <div className="relative">
                    ...
                    <h3 className='text-white text-2xl'>See how we helped Groover to grow 11x faster</h3>
                </div>
            </div>
            ...
            <div className='relative flex flex-col justify-center items-center gap-5 px-5 py-12'>
                <div className="relative avatars">
                    <img src={avatar2} className='-right-12 w-20 top-2 bottom-0 absolute z-10' alt="" />
                    <img src={avatar3} className='w-24 relative z-50' alt="" />
                    <img src={avatar1} className='-left-12 w-20 top-2 bottom-0 absolute z-10' alt="" />
                </div>
                <h3 className="text-xl">Still have questions?</h3>
                <p className="text-white">Can’t find the answer you’re looking for? Please chat to our friendly team.</p>
                <button className='btn bg-white text-green-600 border-0 px-4 py-2 rounded-lg font-bold hover:bg-[#71B131] hover:text-white'>Get in touch</button>
            </div>
        </div>
    );
};
