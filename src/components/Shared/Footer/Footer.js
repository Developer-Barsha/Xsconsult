    ...
    <footer>
      <div className="bg-black flex lg:flex-row flex-col gap-5 justify-between items-center py-10 px-12">
        ...
        <div className="relative w-full lg:w-1/2 flex justify-end">
          <input
            type="text"
            className="p-3 lg:w-2/3 w-full outline-none hover:shadow-lg rounded-lg border-none text-black"
            placeholder="Enter Your Name"
          />
          <button className="absolute top-1 right-1 bg-[#71B131] text-black hover:text-white p-2 rounded-lg">
            Submit
          </button>
        </div>
      </div>
      ...
      <div className="py-10 px-12">
        <div>
          ...
          <p className="mt-3">
            ...
            amet sintAmet minim mollit non deserunt ullamco est sit aliqua dolor
            do amet sint.
          </p>
        </div>
        ...
        <hr className="my-5" />
        <div className="md:flex  gap-10 justify-between max-w-[1280px] ">
          ...
          <p>© 2022 Xsconculting, All Rights Reserved</p>
        </div>
      </div>
    </footer>
  );
